...
export default function TabProperties({
  ...
  const [localAccountProperties, setLocalAccountProperties] = useState([
    ...accountProperties,
  ]);
  ...
  useEffect(() => {
    const newAccountProperties = refreshedList();

    setAccountProperties(newAccountProperties);
    setLocalAccountProperties([...newAccountProperties]);
          ...
          <div>
            <div className="form-group">
              ...
              <Select
                ...
                options={localAccountProperties.filter(
      ...
      <div className="owner-property-tab mb-5">
        ...
        {!!!localAccountProperties.length ? (
          ...
          <div className="p-3">
            ...
            {localAccountProperties.map((property, propertyIndex) => {
